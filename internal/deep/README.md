This is an internal fork (hopefully temporary) of https://github.com/go-test/deep that allows diffing control through struct tags and exposes functional options instead of global vars for config.
